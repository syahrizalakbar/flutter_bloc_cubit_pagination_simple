...
List<ResListUser> resListUserFromJson(String str) => List<ResListUser>.from(json.decode(str).map((x) => ResListUser.fromJson(x)));

String resListUserToJson(List<ResListUser> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
